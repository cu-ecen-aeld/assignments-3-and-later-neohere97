...
#installing busybox
make -j12 ARCH={ARCH} CONFIG_PREFIX=${OUTDIR}/rootfs CROSS_COMPILE=aarch64-none-linux-gnu- install
...
cp -r ${FINDER_DIR}/conf/ ${OUTDIR}/rootfs/home
cp ${FINDER_DIR}/writer ${OUTDIR}/rootfs/home
